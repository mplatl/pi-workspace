report 1070551 "CCS CASH Sales Cr.Memo POS Rct"
{
    // POS0003 28.06.16
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/Rep1070551.CCSCASHSalesCrMemoPOSReceipt.rdl';

    Caption = 'Sales Credit Memo - Cash Receipt';
...
#pragma warning restore AA0217
                        ...
                        dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
                        {
                            ...
                            column(LineAmt_SalesCrMemoLine; "Line Amount" + "Line Discount Amount")
                            {
                            ...
                            column(LineDis_SalesCrMemoLine; StrSubstNo('%1%', "Line Discount %"))
                            {
                            }
                            ...
                            column(Qty_SalesCrMemoLineCaption; Item_Quantity_Lbl)
                            {
                            }
...
#pragma warning restore AA0217
                ...
                trigger OnAfterGetRecord()
                begin
                    CurrReport.Language := ReportLanguage.GetLanguageIdOrDefault("Language Code");
    ...
    begin
        ...
        GNoOfCopies := CCSCashSalesSetup."Cash Receipt CrMemo Copies";
    ...
    var
        ...
        Text001: Label 'Total %1', Comment = '%1=Total';
        Text002: Label 'Total %1 Incl. VAT', Comment = '%1=Total';
        Text003: Label '(Applies to %1 %2)', Comment = '%1=Value1,%2=Value2';
        Text004: Label 'COPY';
