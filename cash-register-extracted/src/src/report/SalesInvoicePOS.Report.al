report 1070540 "CCS CASH Sales Invoice - POS"
{
    // POS0003 28.06.16
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/Rep1070540.CCSCASHSalesInvoicePOS.rdl';

    Caption = 'Sales Invoice - Cash';
...
#pragma warning restore AA0217
                    ...
                    begin
                        ...
                        // CurrReport.PageNo := 1;
                        HeaderText := CopyStr(HeaderText + CopyText, 1, MaxStrLen(HeaderText));
                        TotalSubTotal := 0;
    ...
    begin
        ...
        GNoOfCopies := CCSCashSalesSetup."Cash Invoice Copies";
