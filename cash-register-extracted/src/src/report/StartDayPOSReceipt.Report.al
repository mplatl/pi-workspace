report 1070544 "CCS CASH Start Day POS Receipt"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/Rep1070544.CCSCASHStartDayPOSReceipt.rdl';

    Caption = 'Money Transfer - POS';
