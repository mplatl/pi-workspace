table 1070570 "CCS CASH Trans. Deposit Entry"
{
    Caption = 'Trans. Deposit Entry';
    ...
    fields
    {
        ...
        {
            Caption = 'No.';
            TableRelation = "CCS CASH Store Tender Type".Code where(TenderFunction = const(Deposit),
        ...
        field(11; "Account No."; Code[20])
        {
            ...
            begin
                ...
                if "VAT Bus. Posting Group" = '' then begin
                    CSLSetup.Get();
                    "VAT Bus. Posting Group" := CSLSetup."Deposit VAT Bus. Posting Group";
                end;
    ...
    var
        ...
        cDepositDocument: Label 'Deposits';
...
#pragma warning disable AA0217
          DimMgt.EditDimensionSet("Dimension Set ID", StrSubstNo('%1 %2 %3', cDepositDocument, "Transaction No.", "Line No."), "Shortcut Dimension 1 Code", "Shortcut Dimension 2 Code");
